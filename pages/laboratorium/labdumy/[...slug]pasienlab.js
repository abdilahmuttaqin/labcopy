    ...
    if (router.isReady) {
      (async () => {
        try {
          ...
          const responsePermintaan = await getDetailPermintaanPemeriksaanLaboratorium({id: slug[0]});
          const dataPermintaan = responsePermintaan.data.data;
          setDataPermintaanLaboratorium(dataPermintaan);
          // const groupingId = dataPermintaan.grouping_pemeriksaan_laboratorium_id;
          // const permintaanId = dataPermintaan.id;
